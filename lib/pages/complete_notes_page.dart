...
class CompleteNotesPage extends StatefulWidget {
  @override
  _CompleteNotesPageState createState() => _CompleteNotesPageState();
}

class _CompleteNotesPageState extends State<CompleteNotesPage> {
